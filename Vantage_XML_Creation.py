...
def project_zip():
    ...
    # check the watch folder for .DS files, if exists, remove it. this
    # is so the script does not create and XML from the .DS
    ...
    # loop through directory list, check the len of the file path,
    # if its < 260, archive and move
